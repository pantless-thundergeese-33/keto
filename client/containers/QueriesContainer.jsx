...
const QueriesContainer = props => {
  ...
  else if (props.activity === 'electricity') query = (<ElectricityQueries updateCarbon={props.updateCarbon} />);
  else if (props.activity === 'flight') query = (<FlightQueries updateCarbon={props.updateCarbon} />);
  else if (props.activity === 'shipping') query = (<ShippingQueries updateCarbon={props.updateCarbon} />);
